							...
							<div class="box">
								...
								<div class="row">
									<div class="col-md-4">	
										...
										<div class="form-group">
												<label for="rua">
  												Insira o nome da sua rua: <span class="required">*</span>
											
											<!--	<select class="js-example-basic-single js-states form-control" id="rua" style="width: 80%"></select>-->
												</label>
											...
											<div class="form-group">
												<label for="codigopostal">
  												Insira o seu código postal: <span class="required">*</span>
												<!--<select class="js-example-basic-single js-states form-control" id="codigopostal" style="width: 80%"></select>-->
												</label>
											    ...
											    <div class="col-md-2">
													<div class="form-group">
														<label for="porta">Número de Porta:</label>
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" id="andar">
													</div>
												    </div>	
